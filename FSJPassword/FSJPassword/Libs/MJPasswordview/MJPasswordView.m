...
- (void)initView {
    ...
    self.circleFillColour = COLOR(84.0, 104.0, 130.0, 1.0);
    self.circleFillColourHighlighted = [UIColor blackColor];//[UIColor redColor];
    self.pathColour = COLOR(78.0, 155.0, 266.0, 1.0);//COLOR(31.0, 92.0, 135.0, 1.0);//[UIColor grayColor];
