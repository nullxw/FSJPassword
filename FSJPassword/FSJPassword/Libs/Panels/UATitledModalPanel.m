...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
		...
		self.headerLabel.textAlignment = NSTextAlignmentCenter;//UITextAlignmentCenter;
...
//    CGRect rect = CGRectMake(self.outerMargin + self.innerMargin-self.frame.origin.x,
//							 self.outerMargin + self.innerMargin + y-self.frame.origin.y,
//							 roundedRectFrame.size.width - 2*self.innerMargin,
//							 roundedRectFrame.size.height - y - 2*self.innerMargin);
